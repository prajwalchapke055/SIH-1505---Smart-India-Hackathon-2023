...
('Prajwal Chapke', 'prajwalchapke055@gmail.com', 'This is a text message.'),
('Jane Smith', 'jane.smith@example.com', 'Another test message.'),
('Alice Johnson', 'alice.johnson@example.com', 'Hello, I have a question about the library hours.');
...
-- Table structure for table 'training_awareness'
--
